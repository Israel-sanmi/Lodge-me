  ...
  return (
    <div className="">
      <div className=" md:w-96 w-80">
        <div className="bg-[#F9F9F9] h-96 drop-shadow-xl border border-[#F9A32E] rounded-md">
          <div>
            <img src={feedImg} alt="" className="w-full h-52 object-cover" />
          </div>
          <div className="pl-3">
            <div>
              <p className="md:text-md text-xs leading-6 pt-2">{summary}</p>
            ...
            <div className="flex flex-wrap">
              ...
              <p className="md:text-md py-3 text-sm font-semibold mt-2">
                {avatarName}
              </p>
            </div>
          </div>
