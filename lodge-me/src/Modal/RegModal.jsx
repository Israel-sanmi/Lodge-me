...
const RegModal = ({ handleClose, close }) => {
  ...
  return (
    <div className="fixed w-full h-screen z-10 bg-black/50 inset-0 flex justify-center items-center">
      <div className="">
        <div className="inset-0 md:mt-20 mt-10 lg:ml-96 ml-0 fixed h-[500px] lg:w-1/3 w-full rounded-md flex justify-center items-center p-10 backdrop-blur-md bg-white z-10">
          <div>
            <div>
              <div className="">
